...
def lambda_handler(event, context):
    with conn.cursor() as cur:
        ...
        for node in node_response:
            ...
            todo = {"jsonrpc": "2.0", "method": "platform.getCurrentSupply","id": 1 }
            ...
            mainResult = {'jsonrpc': jData.get("jsonrpc"), 'result':{"supply": result.get("supply"),"nodeId": node[4]}, 'id': jData.get("id")}

            messageData = {"messageType":"CurrentSupply","blockchainType":"Avalanche","timestamp":time.time(),"body":mainResult}
            print("messageData")
            print(messageData)
